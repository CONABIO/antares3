...
from madmex.indexing import add_product_from_yaml, add_dataset
...
To consult the exposed arguments for each model, use the "model_params" command line''')
    ...
    def handle(self, *args, **options):
        ...
        if not load_dataset:
            ...
            logger.info('Completed extraction of training data from {} tiles. Sample: {}'.format(len(arr_list), sample))
